...
<p style="text-align: justify; font-size: 16px">The recent surge of unprecedented data from improved measurement, experimentation, and computation highlights the necessity of Data Analytics. Statistical techniques, supported by advancements in Artificial Intelligence, enable better decision-making and system analysis in a cost-effective manner. I have the grasp of statistics, Machine Learning, and Deep Learning, which I believe will help me advance further in my career as an academician and a researcher.</p>
